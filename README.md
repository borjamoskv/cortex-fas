...
E_total = weighted sum of interpretative tension fields:
...
Outputs are normalized scalar potentials ∈ [0,1].
...
- Doctrinal Tension
- Phase Transition (critical instability)

---

## ⚠️ Adversarial Assumption Layer
